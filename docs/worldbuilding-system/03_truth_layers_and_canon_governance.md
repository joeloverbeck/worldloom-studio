...
A fact is accepted into the authorial model.
...
A secret is plausible only if the system explains:

- who knows;
- how many know;
- what evidence exists;
- who suppresses evidence;
- what it costs to suppress;
- what incentives keep insiders quiet;
- what false explanation circulates;
- how leaks are handled;
- how long secrecy has lasted;
- whether the secret should already have shaped institutions.
...
- dockworkers believe the sea dead bargain with captains because they handle drowned cargo;
- inland priests deny this because it threatens temple authority;
- insurers quietly price voyages as if it is true;
- naval courts accept testimony only from officially bound dead.

### 6. Contradictions must be assigned

If two statements conflict, classify the conflict:
