...
- Read [references/tracker-closeout-gates.md](references/tracker-closeout-gates.md) before declaring completion and immediately before any `gh issue comment`, `gh issue close`, `glab issue close`, or equivalent tracker mutation.
