...
Include a one-line prefactoring verdict for the whole breakdown ("Prefactoring: none needed because …", or a prefactor slice at position 1), so the reader can tell the check ran.
